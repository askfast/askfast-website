  ...
  en:
    ...
    pages:
      home:
        ...
        channels:
          ...
          mail:[
            ...
            'Long codes (Virtual mobile number)'
          ]
          twitter:[
            'Mention user names'
        ...
        faststart:
          row1:
            ...
            content: [
              ...
              'Remember Apple? Their hardware is just facilitating their software experience.
          ...
          row2:
            ...
            content: [
              ...
              or communication?'
              'In both cases you have come to the right place! That\'s the flexibility of ASK-Fast.
          ...
          row3:
            ...
            content: [
              ...
              registration.'
              'Here’s a small list of what you can do with ASK-Fast:'
            ]
            list: [
              'Verify your orders'
              'Verify an account'
          ...
          row4:
            ...
            content: [
              ...
              you a fee.'
              'You don’t need to start from scratch: We provide you with our developer modules,
        ...
        solutions:
          row1:
            ...
            content: [
              ...
              every year and charge you 20% support and maintenance just to keep the thing running?'
          ...
          row2:
            ...
            content: [
              ...
              communication on three levels: Pre-Service, during Service and Post-Service.'
              'Do you want us to check your communication infrastructure? As a premium client
          ...
          row3:
            ...
            content: [
              ...
              'StandBy is the application used by KNRM for availability management of their
        ...
        benefits:
          row1:
            ...
            content: [
              ...
              Saving money, get to market faster, having a more flexible solution!'
          ...
          row2:
            ...
            content: [
              ...
              probably ask him what it is that he is looking for.'
              'ASK-Fast is the automated communication tool that can help you do this, and in a
          ...
          row3:
            ...
            content: [
              ...
              accurately determine  which ad brings in the most business.'
              'What ASK-Fast can do is assign a unique number phone number to each campaign so
          ...
          row5:
            ...
            content: [
              ...
              information after getting confirmation from your account manager.'
              '"Hey John! I just gave you a call, but I think you’re busy. I want to talk to you
              ...
              peter@mycompany.com. Kind Regards, Peter"'
              'Do you also want to receive an SMS when he reads it? Sure, why not. ASK-Fast
      ...
      dialogs:
        row1:
          ...
          content: [
            ...
            but also how you are saying things.'
            'Our team believes that each response can change the next question, which can create
        ...
        row2:
          ...
          content: [
            ...
            'Compared to live human communication, automated communications have lower costs and
        ...
        row3:
          ...
          content: [
            ...
            purpose: collect necessary information with an interactive voice response solution.'
            'The designed communication flow easily converted to SMS - Email communication
        ...
        row4:
          ...
          content: [
            ...
            'We created a marketplace where you can share, show or sell your dialogs to other
        ...
        team:
          ...
          row2:
            ...
            content: [
              ...
              to deliver the best solutions for businesses and end-users.'
              'All partners are young, innovative and fast growing companies. The focus is on
              using the principles of self-organization to aid people.'
              'We would love to welcome you to the family, as an investor or as a partner!'
            ]
            cta: 'Talk to grandpa!'
          row3:
            ...
            content: [
              'Furthermore, we like people with new ideas. You can always apply for an open position.'
            ]
      ...
      legal:
        ...
        list: [
          'We do not sell your personal information, nor contact list (phone, email, social media, etc). We do not share or distribute your contact information unless specifically stated so.'
          'We don’t ask you for personal information unless we need it.'
          'We don’t store personal information on our servers unless required for a specific organizational effort, such as delivering a message to congress, connect you via phone to your representatives, deliver a petition or in order to communicate with you about an upcoming effort.'
        ]
    ...
    pages:
      ...
      legal:
        ...
        content: '(NL) There are many different ways you can use ASK Fast services.
                  ...
                  Among our fundamental principles:'
        list: [
          '(NL) We do not sell your personal information, nor contact list (phone, email, social media, etc). We do not share or distribute your contact information unless specifically stated so.'
          '(NL) We don’t ask you for personal information unless we need it.'
          '(NL) We don’t store personal information on our servers unless required for a specific organizational effort, such as delivering a message to congress, connect you via phone to your representatives, deliver a petition or in order to communicate with you about an upcoming effort.'
        ]
